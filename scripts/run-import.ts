...
async function main() {
  ...
  const summary = await runImport(sb, apiKey, {
    terms: ["비타민D", "오메가", "EPA", "프로바이오틱스", "유산균", "루테인", "비타민C", "아연", "마그네슘", "종합비타민", "멀티비타민", "멀티미네랄", "홍삼", "밀크씨슬", "가르시니아", "코엔자임", "쏘팔메토", "은행잎", "콜라겐", "프로폴리스", "감마리놀렌산", "전립소", "글루코사민", "콘드로이친", "MSM", "관절", "아르기닌", "크랜베리", "히알루론산", "테아닌", "가바", "포스파티딜세린", "대두이소플라본", "강황", "커큐민"],
    log: (m) => console.log(`  ${m}`),
  });

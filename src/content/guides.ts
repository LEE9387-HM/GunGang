  ...
  chapters: [
    ...
    },
    {
      ...
      paras: [
        ...
        "GunGang은 제품에 가격 정보가 있으면 1일 섭취비용과 함량당 단가를 계산해 상세·비교 화면에 표시합니다. 가격은 함량 등급이나 노출 순위에 영향을 주지 않는, 별도의 비교 축입니다.",
      ],
      trap: "'대용량 O개월분'이 저렴해 보여도, 하루치로 환산하면 소용량이 더 쌀 수 있습니다.",
      cta: { label: "제품 상세에서 가성비 확인", href: "/search?category=omega3&sort=amount" },
    },
    {
      title: "4. 중복 섭취 주의",
